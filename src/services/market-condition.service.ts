...
export class MarketConditionService {
	...
	async ka90005(ka90005Param: KA90005Param): Promise<KA90005Response> {
		return this.executeApiCall<KA90005Param, KA90005Response>('ka90005', ka90005Param);
	}

	async ka90006(ka90006Param: KA90006Param): Promise<KA90006Response> {
		return this.executeApiCall<KA90006Param, KA90006Response>('ka90006', ka90006Param);
	}

	async ka90007(ka90007Param: KA90007Param): Promise<KA90007Response> {
		return this.executeApiCall<KA90007Param, KA90007Response>('ka90007', ka90007Param);
	}
	...
	async ka90013(ka90013Param: KA90013Param): Promise<KA90013Response> {
		return this.executeApiCall<KA90013Param, KA90013Response>('ka90013', ka90013Param);
	}
}
